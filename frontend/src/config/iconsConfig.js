...
import {
    ...
    , BiSkipForward, ViFileTypeVue, MdEmailOutlined, BiEyeFill,BiEyeSlashFill 
} from "oh-vue-icons/icons";

addIcons(CoMediaStepBackward, BiGithub, BiShop, HiSolidShoppingCart, ViFileTypeConfig, FaGreaterThan, RiLogoutBoxLine,
    FaUserCircle, IoOptionsOutline, IoClose, BiSkipForward, ViFileTypeVue, MdEmailOutlined,BiEyeFill,BiEyeSlashFill);